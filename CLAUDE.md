...
odin exec   [PROMPT] [--prompt-file PATH] [--project PATH] [--platform NAME] [--model MODEL]
            [--agent-bin PATH] [--permission-mode MODE] [--allowed-tools LIST]
            [--disallowed-tools LIST] [--max-turns N] [--sandbox MODE] [--approve-mcps]
            [--append-system-prompt TEXT] [--no-metrics] [--no-color]
